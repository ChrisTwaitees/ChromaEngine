...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            static ImGuiTextFilter filter;
            filter.RenderScene("Filter colors", ImGui::GetFontSize() * 16);
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            if (ImGui::DragFloat("window scale", &window_scale, 0.005f, 0.3f, 2.0f, "%.2f"))   // m_Scale only this window
                ImGui::SetWindowFontScale(window_scale);
            ImGui::DragFloat("global scale", &io.FontGlobalScale, 0.005f, 0.3f, 2.0f, "%.2f");      // m_Scale everything
            ImGui::PopItemWidth();
...
struct ExampleAppConsole
{
    ...
    void    RenderScene(const char* title, bool* p_open)
    {
        ...
        ImGui::SameLine();
        Filter.RenderScene("Filter (\"incl,-excl\") (\"error\")", 180);
        ImGui::Separator();
...
static void ShowExampleAppConsole(bool* p_open)
{
    ...
    console.RenderScene("Example: Console", p_open);
}
...
struct ExampleAppLog
{
    ...
    void    RenderScene(const char* title, bool* p_open = NULL)
    {
        if (!ImGui::Begin(title, p_open))
        {
            ImGui::End();
        ...
        ImGui::SameLine();
        Filter.RenderScene("Filter", -100.0f);
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    log.RenderScene("Example: Log", p_open);
}
