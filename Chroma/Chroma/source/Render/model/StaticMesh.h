...
namespace Chroma
{
	...
	protected:
		...
		virtual void SetTransformUniforms(Shader& shader, Camera& renderCam);
		virtual void SetMaterialUniforms(Shader& shader);
		virtual void SetTextureUniforms(Shader& shader);
	};
}
