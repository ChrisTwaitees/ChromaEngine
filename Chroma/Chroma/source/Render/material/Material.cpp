...
{
	UpdateTransformUniforms(shader, RenderCam, modelTransform);
	UpdateMaterialUniforms(shader);
	UpdateTextureUniforms(shader);
}

void Material::UpdateTransformUniforms(Shader& shader, Camera& renderCam, const glm::mat4& modelTransfrom)
{
...
void Material::UpdateTextureUniforms(Shader& shader)
{
	// UV Modifiers
...
void Material::UpdatePBRLightingTextureUniforms(Shader& shader)
{
	// Irradiance
